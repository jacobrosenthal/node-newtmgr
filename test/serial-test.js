...
describe('serial', function () {
  ...
  beforeEach(function () {
    ...
    transport = new Serial({readable, writable});
  });
  ...
  it('should encode', function (done) {
    ...
    readable.emit('data', resetCommand);
    readable.emit('end');
  });
  ...
  it('should fragment', function (done) {
    ...
    readable.emit('data', resetEncoded);
    readable.emit('end');
  });
  ...
  it('should accumulate fragmented packet data', function (done) {
    ...
    readable.emit('data', listResponse1);
    readable.emit('data', listResponse2);
    readable.emit('data', listResponse3);
    readable.emit('end');
  });
  ...
  it('should decode', function (done) {
    ...
    readable.emit('data', listResponseAccumulated);
    readable.emit('end');
  });
